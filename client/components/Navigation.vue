      ...
      <ul class="flex items-center">
        <li class="w-40">
          <img
            ...
            src="@/assets/rodekruis.png"
            alt="logo" />
        </li>
        <li>
          <input class=" md:w-48 border-2 rounded bg-gray-200 mt-4 p-4 text-xl w-32 h-16 shadow" placeholder="Search..."/>
        </li>
      </ul>

      <!-- rechts  -->
      <div class="mt-14 relative md: mt-0 flex items-center bg-gray-200 right-0 rounded h-16 shadow">
        ...
        <div v-if="showMenu" class="rounded w-full absolute md:bottom-0 right-0 bg-gray-200 transform translate-y-full z-20" id="dropdown">
          <a href="#" class="block px-4 py-2 text-xl hover:bg-blue-200">Profile</a>
          <NuxtLink to="/login" class="block px-4 py-2 text-xl hover:bg-blue-200">Logout</NuxtLink>
        </div>
      </div>
    </nav>
  </div>
