...
<div class="fixed justify-center items-center inset-0 z-50 flex">
  <div class="bg-white max-w-8xl rounded-lg shadow-lg px-4 py-1">
  ...
  <button class="text-dark-primary p-2 text-3xl rounded-l w-12" @click="$emit('closeCardDetail')"> X </button>
    ...
    <div class= "w-full
   bg-gray-primary text-2xl my-8 rounded-lg flex justify-between items-center hover:bg-gray-secondary px-20 py-8" v-for="task in tasks">
